...
interface IUsCourtComplaintControllerResponse {
  getters: {
    currentFormData: IMultistepFormResponse[];
    usCourtComplaintData: IMultistepFormResponse[];
    formId: string;
  };
  refs: {
...
/**
 * @controller {useUsCourtComplaintController}
 * @return {IUsCourtComplaintControllerResponse}
 */
export const useUsCourtComplaintController =
  (): IUsCourtComplaintControllerResponse => {
    // React Refs
    ...
    const usCourtComplaintData = useAppSelector(US_COURT_FORM_DATA);
