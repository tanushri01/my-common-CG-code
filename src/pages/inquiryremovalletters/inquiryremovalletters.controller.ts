...
interface IInquiryRemovalLettersControllerResponse {
  getters: {
...
/**
 * @controller {useInquiryRemovalLettersController}
 * @return {IInquiryRemovalLettersControllerResponse}
 */
export const useInquiryRemovalLettersController =
  (): IInquiryRemovalLettersControllerResponse => {
    // React Refs
