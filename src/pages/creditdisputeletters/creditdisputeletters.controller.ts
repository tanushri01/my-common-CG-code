...
interface ICreditDisputeControllerResponse {
  getters: {
 ...
 * @return {ICreditDisputeControllerResponse}
 */
export const useCreditDisputeController =
  (): ICreditDisputeControllerResponse => {
    // React Refs
